...
class ArticleListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ArticleListViewBodyWidget();
  }
}

class ArticleListViewBodyWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ArticleListViewBodyWidgetState();
}

class _ArticleListViewBodyWidgetState extends State<ArticleListViewBodyWidget> {
  var _future;
...
//        print("109----" + '$arlstselectedfurniture');
...
//        print(furniture);
  ...
  Container _ArticleListView(data) {
    ...
    String getNumberofFurnitureItems(String operation, String name) {
      int _furnitureselectedItem = 0;
      if (globals.CountedItem.bedroomfurnitureglobal == null) {
        return '0';
      } else if (operation == 'pluse') {
        _furnitureselectedItem = _furnitureselectedItem;
        for (int i = 0;
            i < globals.CountedItem.bedroomfurnitureglobal.length;
            i++) {
          if (name ==
...
//        print(_furnitureselectedItem.abs());
                            ...
                            onPressed: () {
                              ...
                              setState(() {
                                ...
                                globals.CountedItem.bedroomfurnitureglobal
                                    .add(data[index]);
                                print("362    "+globals.CountedItem.bedroomfurnitureglobal.length.toString());
                              });
                            },
                          ),
                          alignment: Alignment(-1, 0),
