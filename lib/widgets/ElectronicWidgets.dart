...
class ArticleElectronicsListView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ArticleElectronicsViewBodyWidget();
  }
}

class ArticleElectronicsViewBodyWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() =>
      _ArticleElectronicsViewBodyWidgetState();
}

class _ArticleElectronicsViewBodyWidgetState
    extends State<ArticleElectronicsViewBodyWidget> {
  var _future;
  ...
  Container _ArticleListView(data) {
    String getNumberofElectronicsItems(String operation, String name) {
      ...
      if (globals.CountedItem.bedroomelectronicsglobal == null) {
        return '0';
      } else if (operation == 'pluse') {
        _electronicsselectedItem = _electronicsselectedItem;
        for (int i = 0;
            i < globals.CountedItem.bedroomelectronicsglobal.length;
            i++) {
          if (name ==
              globals.CountedItem.bedroomelectronicsglobal[i].articleName) {
