...
class VehicleListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VehicleFurnitureBodyWidget();
  }
}

class VehicleFurnitureBodyWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _VehicleFurnitureBodyWidgetState();
}

class _VehicleFurnitureBodyWidgetState
    extends State<VehicleFurnitureBodyWidget> {
  var _future;
  ...
  Container _ArticleListView(data) {
    String getNumberofVehiclesItems(String operation, String name) {
      int _furnitureselectedItem = 0;
      if (globals.CountedItem.vehicleglobal == null) {
        return '0';
      } else if (operation == 'pluse') {
        _furnitureselectedItem = _furnitureselectedItem;
        for (int i = 0; i < globals.CountedItem.vehicleglobal.length; i++) {
          if (name == globals.CountedItem.vehicleglobal[i].articleName) {
                        ...
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () {
                              ...
                              setState(() {
                                data[index].qty++;
                                globals.CountedItem.vehicleglobal
                                    .add(data[index]);
                              });
                            },
                          ),
