...
class LivingroomFurnitureListView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return LivingroomFurnitureBodyWidget();
  }
}

class LivingroomFurnitureBodyWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _LivingroomFurnitureBodyWidgetState();
}

class _LivingroomFurnitureBodyWidgetState
    extends State<LivingroomFurnitureBodyWidget> {
  var _future;
  ...
  Container _ArticleListView(data) {
    String getNumberofFurnitureItems(String operation, String name) {
      ...
      if (globals.CountedItem.livingroomfurnitureglobal == null) {
        return '0';
      } else if (operation == 'pluse') {
        _furnitureselectedItem = _furnitureselectedItem;
        for (int i = 0;
        i < globals.CountedItem.livingroomfurnitureglobal.length;
        i++) {
          if (name ==
              globals.CountedItem.livingroomfurnitureglobal[i].articleName) {
            _furnitureselectedItem += 1;
//            print("177" + _furnitureselectedItem.toString());
//            print("178  ----   " +
//                name +
//                "-----" +
//                globals.CountedItem.bedroomfurnitureglobal[i].articleName);
          }
        }
  ...
  Text _tile(String title, String id) =>
      Text(
        title,
        style: TextStyle(
