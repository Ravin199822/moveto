...
class LivingRoomElectronicsListView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return LivingRoomElectronicsViewBodyWidget();
  }
}

class LivingRoomElectronicsViewBodyWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() =>
      _LivingRoomElectronicsViewBodyWidgetState();
}

class _LivingRoomElectronicsViewBodyWidgetState
    extends State<LivingRoomElectronicsViewBodyWidget> {
  var _future;
  ...
  Container _ArticleListView(data) {
    String getNumberofElectronicsItems(String operation, String name) {
      ...
      if (globals.CountedItem.livingroomelectronicsglobal == null) {
        return '0';
      } else if (operation == 'pluse') {
        _electronicsselectedItem = _electronicsselectedItem;
        for (int i = 0;
            i < globals.CountedItem.livingroomelectronicsglobal.length;
            i++) {
          if (name ==
              globals.CountedItem.livingroomelectronicsglobal[i].articleName) {
